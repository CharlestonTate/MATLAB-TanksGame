function tank_wall_editor
    ...
    % Mouse callbacks - attach to figure, not axes
    ...
    function startDrawing(~, ~)
        ...
        axWidth = axPos(3);
        axHeight = axPos(4);
        relX = (mousePos(1) - axPos(1)) / axWidth;
        relY = (mousePos(2) - axPos(2)) / axHeight;
        
        dataX = 0.5 + relX * gridSize;
        dataY = 0.5 + relY * gridSize;
